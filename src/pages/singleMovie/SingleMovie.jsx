                ...
                <div className='container mx-auto text-white mb-[30px] overflow-hidden select-none'>
                    {
                        oneImage && images?.backdrops[index] ? (
                            ...
                            <>
                                <div className='mb-4'>
                                    {data?.backdrop_path ? (
                                        <div className="relative select-none overflow-hidden rounded-[30px]">
                                        <img
                                            src={url + data.backdrop_path}
                                            alt={data.title}
                                            className="w-full h-[500px] object-cover rounded-[30px]"
                                        />
                                        <div className="absolute inset-0 rounded-[30px] bg-gradient-to-t from-black/90 via-black/40 to-transparent pointer-events-none"></div>
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 p-6">
                                            ...
                                            style={{ fontFamily: 'Verdana, sans-serif', fontSize: '18px' }}
                                            >
